...
<body class="<?php print $body_classes; ?>">
  <div id="page">
    ...
    <div id="closure"><div id="closure-inner" class="clearfix"><div id="designed-by"><small><a href="http://www.antsin.com" title="Drupal theme">Drupal Theme by Antsin</a></small></div><?php print $closure_region; ?></div></div>
